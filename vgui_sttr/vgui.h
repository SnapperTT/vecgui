...
void Vgui_TextSubWidget::sttr_register ()
		...
		R.beginClass<Vgui_TextSubWidget>("Vgui_TextSubWidget")
			.STTR_REG_PROP(Vgui_TextSubWidget,text,VGUI_PERSISTANT)
			.STTR_REG_PROP(Vgui_TextSubWidget,r,VGUI_PERSISTANT)
			.STTR_REG_PROP(Vgui_TextSubWidget,g,VGUI_PERSISTANT)
			.STTR_REG_PROP(Vgui_TextSubWidget,b,VGUI_PERSISTANT)
			.STTR_REG_PROP(Vgui_TextSubWidget,a,VGUI_PERSISTANT)
		.endClass();
		}
...
void Vgui_ContextI::sttr_register ()
		...
		R.beginClass<Vgui_ContextI>("Vgui_ContextI")
			.STTR_REG_PROP(Vgui_ContextI,mCanvas,0)
			.STTR_REG_PROP(Vgui_ContextI,canvasXSz,0)
			.STTR_REG_PROP(Vgui_ContextI,canvasYSz,0)
			.STTR_REG_PROP(Vgui_ContextI,scalef,0)
			.STTR_REG_PROP(Vgui_ContextI,redrawRq,0)

			.STTR_REG_METH(Vgui_ContextI,bind,0)
			.STTR_REG_METH(Vgui_ContextI,setCanvas,0)
			.STTR_REG_METH(Vgui_ContextI,requestRedraw,0)
			.STTR_REG_METH(Vgui_ContextI,fetchElement,0)
			.STTR_REG_METH(Vgui_ContextI,fetchBool,0)
			.STTR_REG_METH(Vgui_ContextI,fetchDouble,0)
			.STTR_REG_METH(Vgui_ContextI,fetchText,0)
			.STTR_REG_METH(Vgui_ContextI,genPrerenderedText,0)
			.STTR_REG_METH(Vgui_ContextI,resizeCanvas,0)
			.STTR_REG_METH(Vgui_ContextI,renderTriangle,0)
			.STTR_REG_METH(Vgui_ContextI,renderQuad,0)
			.STTR_REG_METH(Vgui_ContextI,renderQuadWH,0)
			.STTR_REG_METH(Vgui_ContextI,setColor,0)
			.STTR_REG_METH(Vgui_ContextI,setColorF,0)
			.STTR_REG_METH(Vgui_ContextI,clear,0)
			.STTR_REG_METH(Vgui_ContextI,pushScissor,0)
			.STTR_REG_METH(Vgui_ContextI,popScissor,0)
			.STTR_REG_METH(Vgui_ContextI,isScissorCulled_element,0)
			.STTR_REG_METH(Vgui_ContextI,isScissorCulled_region,0)
			.STTR_REG_METH(Vgui_ContextI,renderText,0)
			//.STTR_REG_METH(Vgui_ContextI,getTextSize,0)
			.STTR_REG_METH(Vgui_ContextI,getTextWidth_lua,0)
			.STTR_REG_METH(Vgui_ContextI,getTextHeight_lua,0)
			.STTR_REG_METH(Vgui_ContextI,getTextCaretPos,0)
			.STTR_REG_METH(Vgui_ContextI,getTextLineHeight,0)
			.STTR_REG_METH(Vgui_ContextI,getTime,0)
			.STTR_REG_METH(Vgui_ContextI,draw,0)
			.STTR_REG_METH(Vgui_ContextI,pollMouseState,0)
			.STTR_REG_METH(Vgui_ContextI,processMouseEvent,0)
			.STTR_REG_METH(Vgui_ContextI,processKeyEvent,0)
			//.STTR_REG_METH(Vgui_ContextI,processTextInputEvent,0)
			.STTR_REG_METH(Vgui_ContextI,setGradient,0)
			.STTR_REG_METH(Vgui_ContextI,clearGradient,0)
		.endClass();
		}
...
void Vgui_StyleWrap::sttr_register ()
		...
		R.beginClass<Vgui_StyleWrap>("Vgui_StyleWrap")
			.STTR_REG_PROP(Vgui_StyleWrap, mStyle, VGUI_PERSISTANT) // | VGUI_OWNS_POINTER)
		.endClass();
		}
...
void Vgui_Widget::sttr_register ()
		...
		R.beginClass<Vgui_Widget>("Vgui_Widget")
			.STTR_REG_PROP(Vgui_Widget,mParent,0)
			.STTR_REG_PROP(Vgui_Widget,mStyleWrap,0)
			.STTR_REG_PROP(Vgui_Widget,tag,VGUI_PERSISTANT | VGUI_ZT)
			
			.STTR_REG_PROP(Vgui_Widget,x,VGUI_PERSISTANT)
			.STTR_REG_PROP(Vgui_Widget,y,VGUI_PERSISTANT)
			.STTR_REG_PROP(Vgui_Widget,xs,VGUI_PERSISTANT)
			.STTR_REG_PROP(Vgui_Widget,ys,VGUI_PERSISTANT)
			
			.STTR_REG_PROP(Vgui_Widget,r,VGUI_PERSISTANT)
			.STTR_REG_PROP(Vgui_Widget,g,VGUI_PERSISTANT)
			.STTR_REG_PROP(Vgui_Widget,b,VGUI_PERSISTANT)
			.STTR_REG_PROP(Vgui_Widget,a,VGUI_PERSISTANT)
			
			.STTR_REG_PROP(Vgui_Widget,innerPaddingT,VGUI_PERSISTANT | VGUI_ZT)
			.STTR_REG_PROP(Vgui_Widget,innerPaddingB,VGUI_PERSISTANT | VGUI_ZT)
			.STTR_REG_PROP(Vgui_Widget,innerPaddingL,VGUI_PERSISTANT | VGUI_ZT)
			.STTR_REG_PROP(Vgui_Widget,innerPaddingR,VGUI_PERSISTANT | VGUI_ZT)
			
			.STTR_REG_PROP(Vgui_Widget,outerPaddingT,VGUI_PERSISTANT | VGUI_ZT)
			.STTR_REG_PROP(Vgui_Widget,outerPaddingB,VGUI_PERSISTANT | VGUI_ZT)
			.STTR_REG_PROP(Vgui_Widget,outerPaddingL,VGUI_PERSISTANT | VGUI_ZT)
			.STTR_REG_PROP(Vgui_Widget,outerPaddingR,VGUI_PERSISTANT | VGUI_ZT)
			
			.STTR_REG_PROP(Vgui_Widget,xScroll,VGUI_PERSISTANT | VGUI_ZT)
			.STTR_REG_PROP(Vgui_Widget,xScrollMax,VGUI_PERSISTANT | VGUI_ZT)
			.STTR_REG_PROP(Vgui_Widget,yScroll,VGUI_PERSISTANT | VGUI_ZT)
			.STTR_REG_PROP(Vgui_Widget,yScrollMax,VGUI_PERSISTANT | VGUI_ZT)
			
			.STTR_REG_PROP(Vgui_Widget,horizontalAlignment,VGUI_PERSISTANT)
			.STTR_REG_PROP(Vgui_Widget,verticalAlignment,VGUI_PERSISTANT)
			.STTR_REG_PROP(Vgui_Widget,widthMode,VGUI_PERSISTANT)
			.STTR_REG_PROP(Vgui_Widget,heightMode,VGUI_PERSISTANT)
			.STTR_REG_PROP(Vgui_Widget,xPosMode,VGUI_PERSISTANT)
			.STTR_REG_PROP(Vgui_Widget,yPosMode,VGUI_PERSISTANT)
			
			.STTR_REG_PROP(Vgui_Widget,text,VGUI_PERSISTANT | VGUI_ZT)
			.STTR_REG_PROP(Vgui_Widget,value,VGUI_PERSISTANT | VGUI_ZT)
			.STTR_REG_PROP(Vgui_Widget,caretPosition,0)
			.STTR_REG_PROP(Vgui_Widget,caretSelectionStart,0)
			
			.STTR_REG_PROP(Vgui_Widget,isActive,0)
			.STTR_REG_PROP(Vgui_Widget,isHovering,0)
			.STTR_REG_PROP(Vgui_Widget,isXScrollbarActive,0)
			.STTR_REG_PROP(Vgui_Widget,isXScrollbarHovering,0)
			.STTR_REG_PROP(Vgui_Widget,isYScrollbarActive,0)
			.STTR_REG_PROP(Vgui_Widget,isYScrollbarHovering,0)
			.STTR_REG_PROP(Vgui_Widget,isAutoscrolling,0)
			
			.STTR_REG_PROP(Vgui_Widget,isDirty,0)
			.STTR_REG_PROP(Vgui_Widget,drawX,0)
			.STTR_REG_PROP(Vgui_Widget,drawY,0)
			.STTR_REG_PROP(Vgui_Widget,drawWidth,0)
			.STTR_REG_PROP(Vgui_Widget,drawHeight,0)
			
			.STTR_REG_PROP(Vgui_Widget,mChildren,VGUI_PERSISTANT | VGUI_OWNS_POINTER | VGUI_ZT)
		
			// Methods
			.STTR_REG_METH(Vgui_Widget,purgeChildren,0)
			.STTR_REG_METH(Vgui_Widget,repairLinks,0)
		//	.STTR_REG_METH(Vgui_Widget,wrangleSkin,0) 
		//	.STTR_REG_METH(Vgui_Widget,getStylePadding,0)
			.STTR_REG_METH(Vgui_Widget,getRoot,0)
			.STTR_REG_METH(Vgui_Widget,addChild,0)
			.STTR_REG_METH(Vgui_Widget,addChildTagged,0)
			.STTR_REG_METH(Vgui_Widget,removeChild,0)
			.STTR_REG_METH(Vgui_Widget,disableRecursive,0)
			.STTR_REG_METH(Vgui_Widget,setPos,0)
			.STTR_REG_METH(Vgui_Widget,setSize,0)
			.STTR_REG_METH(Vgui_Widget,setPosAndSize,0)
			.STTR_REG_METH(Vgui_Widget,setDimMode,0)
			.STTR_REG_METH(Vgui_Widget,setDimModeBoth,0)
			.STTR_REG_METH(Vgui_Widget,setPosMode,0)
			.STTR_REG_METH(Vgui_Widget,setPosModeBoth,0)
			.STTR_REG_METH(Vgui_Widget,setWidth,0)
			.STTR_REG_METH(Vgui_Widget,setHeight,0)
			.STTR_REG_METH(Vgui_Widget,setInnerPadding,0)
			.STTR_REG_METH(Vgui_Widget,setOuterPadding,0)
			.STTR_REG_METH(Vgui_Widget,setInnerPaddingAll,0)
			.STTR_REG_METH(Vgui_Widget,setOuterPaddingAll,0)
			.STTR_REG_METH(Vgui_Widget,setText,0)
			.STTR_REG_METH(Vgui_Widget,getText,0)
			.STTR_REG_METH(Vgui_Widget,setColor,0)
			.STTR_REG_METH(Vgui_Widget,setColorF,0)
			.STTR_REG_METH(Vgui_Widget,setAlignment,0)
			.STTR_REG_METH(Vgui_Widget,setAlignmentH,0)
			.STTR_REG_METH(Vgui_Widget,setAlignmentV,0)
			.STTR_REG_METH(Vgui_Widget,setTag,0)
			.STTR_REG_METH(Vgui_Widget,updateCachedAbsValues,0)
			.STTR_REG_METH(Vgui_Widget,getByTag,0)
			.STTR_REG_METH(Vgui_Widget,draw,0)
			.STTR_REG_METH(Vgui_Widget,draw_recursive,0)
			.STTR_REG_METH(Vgui_Widget,pollMouseState,0)
			.STTR_REG_METH(Vgui_Widget,processMouseEvent,0)
			.STTR_REG_METH(Vgui_Widget,processKeyEvent,0)
			//.STTR_REG_METH(Vgui_Widget,processTextInputEvent,0)
			.STTR_REG_METH(Vgui_Widget,pollMouseState_recursive,0)
			.STTR_REG_METH(Vgui_Widget,processMouseEvent_recursive,0)
			.STTR_REG_METH(Vgui_Widget,processKeyEvent_recursive,0)
			//.STTR_REG_METH(Vgui_Widget,processTextInputEvent_recursive,0)
			.STTR_REG_METH(Vgui_Widget,isMouseInRegion,0)
			.STTR_REG_METH(Vgui_Widget,isMouseInElement,0)
			.STTR_REG_METH(Vgui_Widget,setCaretPosBasedOnPos,0)
			.STTR_REG_METH(Vgui_Widget,setCaretPosToEnd,0) 
		.endClass();
		}
...
void Vgui_Frame::sttr_register ()
		...
		R.deriveClass<Vgui_Widget,Vgui_Frame>("Vgui_Frame")
			.STTR_REG_METHN(Vgui_Frame,upcast,0)
			.STTR_REG_METHN(Vgui_Frame,upcastC,0)
		.endClass();
		}
...
void Vgui_Button::sttr_register ()
		...
		R.deriveClass<Vgui_Widget,Vgui_Button>("Vgui_Button")
			.STTR_REG_METHN(Vgui_Button,upcast,0)
			.STTR_REG_METHN(Vgui_Button,upcastC,0)
		.endClass();
		}
...
void Vgui_Text::sttr_register ()
		...
		R.deriveClass<Vgui_Widget,Vgui_Text>("Vgui_Text")
			.STTR_REG_METHN(Vgui_Text,upcast,0)
			.STTR_REG_METHN(Vgui_Text,upcastC,0)
		.endClass();
		}
...
void Vgui_TextEdit::sttr_register ()
		...
		R.deriveClass<Vgui_Widget,Vgui_TextEdit>("Vgui_TextEdit")
			.STTR_REG_METHN(Vgui_TextEdit,upcast,0)
			.STTR_REG_METHN(Vgui_TextEdit,upcastC,0)
		.endClass();
		}
...
void Vgui_MultilineText::sttr_register ()
		...
		R.deriveClass<Vgui_Widget,Vgui_MultilineText>("Vgui_MultilineText")
			.STTR_REG_METHN(Vgui_MultilineText,addLine,0)
			.STTR_REG_METHN(Vgui_MultilineText,upcast,0)
			.STTR_REG_METHN(Vgui_MultilineText,upcastC,0)
		.endClass();
